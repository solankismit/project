    ...
    <>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              Qualitude brings together sustainable energy solutions and cutting-edge technology 
              to create a brighter, more efficient future for businesses worldwide.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 p-8 shadow-lg transition-all hover:shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-6">
                  Harness the power of sustainable energy with our innovative solar solutions, 
                  designed to reduce costs and environmental impact.
                </p>
                <Link href="/solar">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 p-8 shadow-lg transition-all hover:shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl font-bold mb-4">Qualitude Technologies</h2>
                <p className="text-muted-foreground mb-6">
                  Transform your business with our advanced technology solutions, 
                  from custom software development to IT consulting.
                </p>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-16">Why Choose Qualitude?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Integrated Solutions",
                description: "Seamlessly combine sustainable energy and technology solutions for maximum efficiency."
              },
              {
                title: "Industry Expertise",
                description: "Years of experience in both solar energy and technology sectors."
              },
              {
                title: "Innovation Focus",
                description: "Constantly evolving and adapting to bring you the latest advancements."
              }
            ].map((feature, index) => (
